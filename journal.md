...
<li>The imprisoned githyanki is close to breaking free with the help of its allies. The mind flayer is struggling to keep him subdued. Without our help, it will not succeed. We must destroy the githyanki assailants.</li>
<li>The mind flayer revealed itself as none other than our Dream Visitor. It is a rogue illithid, and just like us, it wishes to be free of the elder brain's domination. By helping it to subdue the githyanki prince Orpheus, we remain protected from the Absolute's power.</li>
<li class="q-raw">ID: <code>INT_HelpDaisy</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>FOR_DangerousBook</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>FOR_DangerousBook_SUB_EvilTome</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>FOR_DangerousBook_SUB_UseTome</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>WYR_Clown</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>WYR_Donations</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>LOW_FindBhaalTemple</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>LOW_FindBhaalTemple_FollowMurders</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>GLO_DealWithTheBrain</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>GLO_FreeOrpheus</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>GLO_HelpVoss</code></li>
</ul>
</details>
...
<li class="q-raw">ID: <code>GLO_RaphaelDeal</code></li>
</ul>
</details>

### Companion questlines

<details class="quest-entry"><summary><span class="q-title">Call of the Blood</span><span class="q-count">5 entries</span></summary>
<ul>
...
<details class="quest-entry"><summary><span class="q-title">The Wizard of Waterdeep</span><span class="q-count">20 entries</span></summary>
<ul>
...
<details class="quest-entry"><summary><span class="q-title">The Githyanki Warrior</span><span class="q-count">38 entries</span></summary>
<ul>
...
<details class="quest-entry"><summary><span class="q-title">Daughter of Darkness</span><span class="q-count">29 entries</span></summary>
<ul>
...
<li>We spoke to Shadowheart about the pain that her mysterious wound inflicted on her. She pleaded ignorance, though she may be withholding something.</li>
<li>Last night, we woke up to Lae'zel and Shadowheart about to kill each other. Luckily, we were able to calm them both down.</li>
<li>We learned that Shadowheart needs to reach Baldur's Gate to fulfil a mission for her goddess - though the details of that mission are a mystery.</li>
<li>We discovered the Gauntlet of Shar - a huge, ancient temple dedicated to the dark goddess. Shadowheart will surely want to investigate further.</li>
<li>Shadowheart has been gripped with intense pain from her wound on many occasions now. This could prove to become a liability if we cannot help her.</li>
<li>Although Shadowheart tried to hide it, we discovered that she worships the goddess Shar. We need to ensure she doesn't keep anything else from us.</li>
<li>Shadowheart spared the Nightsong, in spite of Shar's demands that she be sacrificed. Shar will no doubt be furious, but the Nightsong seems to know something about Shadowheart's past. Whatever secrets she can reveal may be worth risking the wrath of a goddess.</li>
<li>Shar has punished Shadowheart by stripping her of all favours and exiling her from her church. Now all Sharrans will view Shadowheart as a pariah and an enemy. All she can do now is seek out the counsel of Nightsong - or Dame Aylin, as she is known - and see what answers she can provide.</li>
<li>Dame Aylin revealed the truth to Shadowheart. She was not saved by Sharrans as a child, but abducted and indoctrinated by them. Furthermore, her parents still live in Sharran captivity, and are bound to their daughter by a curse - the source of the pain that emanates from Shadowheart's wound. Shadowheart must make for Baldur's Gate in order to rescue her parents and free herself from Shar's influence.</li>
...
<li>We have found a Sharran lookout called Ferg Drogher. He revealed that the cloister is hidden in a place called the House of Grief, in the Lower City of Baldur's Gate.</li>
<li>We recruited a half-elf named Shadowheart. She was also infected aboard the nautiloid. For some reason, she doesn't seem to trust Lae'zel.</li>
<li class="q-raw">ID: <code>ORI_Avatar_ShadowHeart</code></li>
</ul>
</details>

<details class="quest-entry"><summary><span class="q-title">The Chosen of Shar</span><span class="q-count">27 entries</span></summary>
<ul>
...
<li>We learned that Grymforge leads to an ancient temple. Perhaps the truth of what happened to the Dark Justiciars can be discovered there.</li>
<li>The bridge to the ancient temple has been destroyed - there must be another way in.</li>
<li>We found traces of Hellish fiends. Could they have killed the Dark Justiciars? If so, where is their temple of Shar?</li>
<li>A great many Dark Justiciars seem to have perished while fighting near the graveyard. We must be drawing close to the place Shadowheart wishes to find.</li>
<li>We discovered an ancient temple dedicated to Shar. This will be of great interest to Shadowheart - we should investigate further with her.</li>
<li>We completed the Soft-Step Trial in the Gauntlet of Shar. Shadowheart was greatly pleased.</li>
<li>We triumphed at the Self-Same Trial in the Gauntlet of Shar. Shadowheart was most satisfied  by the progress made.</li>
<li>We successfully navigated the Faith-Leap Trial in the Gauntlet of Shar, leaving Shadowheart elated.</li>
<li>Shadowheart revealed to us that in order to become a Dark Justiciar, she must first acquire a weapon called the Spear of Night, hidden somewhere in the Silent Library.</li>
<li>Shadowheart realised that this temple is the legendary Gauntlet of Shar - a proving ground where initiates would seek to become Dark Justiciars. After investigating an altar, she learned that a series of trials must be overcome in order to be anointed a warrior of Shar. Shadowheart wishes to complete the trials and become a Dark Justiciar herself.</li>
<li>We have found the Spear of Night. Now we only need to clear the way to the Inner Sanctum of the Gauntlet of Shar, where Shadowheart seeks to be anointed as a Dark Justiciar.</li>
<li>We have surmounted all the trials and cleared the way to the Inner Sanctum. Shadowheart is now very close to proving herself to Shar and becoming a Dark Justiciar. We should accompany her downwards.</li>
<li>We have entered the Shadowfell - Shar's very own realm. We must descend to where a final test awaits Shadowheart. However, Balthazar, necromancer and ally of Ketheric Thorm, is also present, and may pose a threat to Shadowheart's ambitions if we do not intervene.</li>
<li>We have decided to turn on Balthazar. Now we must defeat him so that Shadowheart can deal with Nightsong.</li>
<li>We convinced Shadowheart to turn her back on Shar's wishes, and instead free Nightsong. Rather than become a Dark Justiciar, Shadowheart will instead likely face dire consequences for her actions.</li>
...
<li class="q-raw">ID: <code>ORI_COM_Astarion</code></li>
</ul>
</details>

<details class="quest-entry"><summary><span class="q-title">The Grand Duke</span><span class="q-count">11 entries</span></summary>
<ul>
...
<li class="q-raw">ID: <code>HIDDEN_SCL_Boosters</code></li>
</ul>
</details>
