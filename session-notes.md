...
### Current location
Party level 11, split across two spots — Lae'zel and TMind are back at **camp**, Kao and Astarion are at **Sorcerous Sundries, Ramazith's Tower**, Lower City. (Previously Wyrm's Rock Fortress, `WYR_Fortress_SUB`, ~106h playtime.)
...
### Active party
Kao (Conjuration Wizard), Astarion (Thief Rogue), Lae'zel (Battle Master Fighter), TMind (Death Domain Cleric). Active summon: Deva (Planar Ally) at camp; Kao's Conjure Elemental (Air) still with him at the tower.
