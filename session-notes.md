...
### Current location
Whole party is now **Level 12**. TMind and Lae'zel are back at **camp**; Kao and Astarion are at **Baldur's Mouth Basement**, Lower City. (~119h playtime.)
...
### Active party
Kao (Conjuration Wizard), Astarion (Thief Rogue), Lae'zel (Battle Master Fighter / War Domain Cleric — respecced multiclass), TMind (Death Domain Cleric). Active summon: Deva (Planar Ally), with the camp pair (TMind/Lae'zel). Kao's Conjure Elemental (Air) summon is no longer active.
