...
> - Caught a real combo the user pointed out: Lae'zel picked up the **Commander's Strike** maneuver (confirmed on bg3.wiki), which grants an ally a reaction to make a melee attack. With Astarion's extra reaction from Duellist's Prerogative, he can take that granted attack on his *first* reaction and still have his second free for Withering Cut or a real opportunity attack. Documented as [[11_Main_Character_Builds#^laezel-build|Lae'zel's build § Commander's Strike → Astarion Reaction Combo]] and added to the Readiness Audit's Before a Hard Fight checklist.
